    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card form-card shadow-sm">
            <div class="card-body p-4 p-md-5">
                <h4 class="mb-4 text-dark fw-bold"><i class="fas fa-plus-circle text-primary me-2"></i> Create New Category</h4>
                ...
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="e.g. Landscaping" value="{{ old('name') }}" required>
