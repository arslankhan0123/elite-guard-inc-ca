        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="rts__breadcrumb__content" style="background-image: url('{{ asset('frontend/images/29.jpg') }}');">
                    ...
                    <div class="hero-top-title" data-aos="fade-up">REQUEST A QUOTE</div>
                    ...
                    <p class="hero-desc" data-aos="fade-up" data-aos-delay="100">
                        Contact us today to receive a personalized quote tailored to your specific security requirements.
                    </p>
