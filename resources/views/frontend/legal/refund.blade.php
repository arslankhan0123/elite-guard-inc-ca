...
<div class="container mt-4">
    <section class="rts__breadcrumb__area" style="position: relative; overflow: hidden; background-image: url('{{ asset('frontend/assets/img/refund_banner_bg.png') }}'); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 95px 20px; text-align: center; border-radius: 20px; margin-bottom: 40px; box-shadow: 0 15px 35px rgba(0, 0, 0, 0.15);">
        ...
        <div style="position: relative; z-index: 2;">
            <h1 style="color: white; font-weight: 800; font-size: 40px; margin-bottom: 10px; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">Refund & Cancellation Policy</h1>
            <p style="color: rgba(255, 255, 255, 0.85); font-size: 16px; margin: 0;">Billing adjustments, contract cancellations, and deposit terms for security services.</p>
        </div>
    </section>
</div>
