...
<style>
    ...
    .apply-form-container .form-control, .apply-form-container .form-select {
            ...
            <div class="row mb-5 pb-5">
                        ...
                        @if($careers->count() > 0)
                            ...
                            <div class="job-card">
                                @if($career->feature_image)
                                    <img src="{{ asset($career->feature_image) }}" alt="{{ $career->title }}" class="job-card-img">
                                @else
                                ...
                                <div class="job-info">
                                    ...
                                    <div class="job-meta">
                                        <span class="me-3"><i class="fa-solid fa-location-dot"></i> {{ $career->location }}</span>
                                        <span><i class="fa-solid fa-briefcase"></i> {{ $career->job_type }}</span>
                                    </div>
                                </div>
                                <div>
                                    <button class="btn-apply-job trigger-apply" data-job-id="{{ $career->id }}">Apply Now <i class="fa-solid fa-arrow-right ms-1"></i></button>
                                </div>
                            </div>
                            @endforeach
                        @else
                            <div class="alert alert-info border-0 shadow-sm">
                                <i class="fa-solid fa-info-circle me-2"></i> No open positions at the moment. Please check back later!
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-lg-6" id="apply-form-section">
                    <div class="apply-form-container">
                        ...
                        <p class="text-muted mb-4">Join our team today. Submit your information and we'll be in touch.</p>
                        
                        <form id="careerApplyForm" action="{{ route('career.apply') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="upload-area" onclick="document.getElementById('cvUpload').click()">
                                    ...
                                    <p class="mb-0 fw-semibold text-dark">Drag & drop your resume here <br> or click to browse</p>
                                    <span class="small text-muted">PDF, DOC or DOCX (Max 5 MB)</span>
                                </div>
                                <input type="file" name="cv" id="cvUpload" class="d-none" accept=".pdf,.doc,.docx" required>
                                <div id="fileNameDisplay" class="mt-2 text-success fw-bold small d-none"></div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label">Additional Information</label>
                                <textarea name="message" class="form-control" rows="3" placeholder="Tell us more about yourself..."></textarea>
                            </div>

                            <button type="submit" class="btn-submit-form" id="submitBtn">
                                <span class="btn-text">Submit Application</span> <i class="fa-solid fa-arrow-right ms-2 btn-icon"></i>
                            </button>
                        </form>
                    </div>
                </div>
