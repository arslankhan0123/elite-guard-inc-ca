        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="rts__breadcrumb__content" style="background-image: url('{{ asset('frontend/images/industries/banner.png') }}');">
                    ...
                    <h2 class="title rts-text-anime">{{ $selected_category ? $selected_category->name : 'Our Security Services' }}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-lg-8 text-center">
                <p class="text-uppercase mb-2" style="font-weight: 700; letter-spacing: 2px; color: #b8860b;">Professional Protection</p>
                ...
                <p class="text-muted mx-auto" style="font-size: 1.1rem; max-width: 800px;">
                    We offer a wide range of highly specialized security services to ensure the safety, protection, and peace of mind of your personnel, assets, and properties.
                </p>
            </div>
        </div>
